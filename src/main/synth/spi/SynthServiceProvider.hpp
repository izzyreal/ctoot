...
namespace ctoot::synth {
    ...
    namespace spi {
        ...
        protected:
            virtual std::shared_ptr<ctoot::synth::SynthControls>
            createControls(std::weak_ptr<ctoot::service::ServiceDescriptor> d);

        public:
            virtual std::shared_ptr<ctoot::synth::MidiSynth>
            createSynth(std::weak_ptr<ctoot::synth::SynthControls>)
            {
                return {};
            }
            ...
            SynthServiceProvider()
            { providerName = "SynthServiceProvider dummy"; }
